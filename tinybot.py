...
class TinychatBot(pinylib.TinychatRTCClient):
    ...
    def cmd_handler(self, msg):
        ...
        if _user.user_level < 5:
            ...
            elif cmd == prefix + 'kick333':
                threading.Thread(target=self.do_kick,
                                 args=(cmd_arg,)).start()

            elif cmd == prefix + 'ban333':
        ...
        if cmd == prefix + 'camban333':  # dirty 2 minutes hack code /// requested guest camban
    ...
    def do_help(self):
        ...
        admin_cmds = ["+mod", "-mod", "acc"]
        mod_cmds = ["announcement", "lockdown", "lockup", "+tmod", "-tmod", "spam", "vip", "verbose", "allowcam"]
        cmod_cmds = ["clr", "camban333", "kick333", "ban333", "unb", "sbl", "fg", "cam", "close333", "+banwword", "-badword",
                     "noguest",
